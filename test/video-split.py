...
def main():
    parser = argparse.ArgumentParser(
        description="Extract video segment with optional title overlay"
    )
    ...
    parser.add_argument(
        "--duration", type=int, default=65, help="Title overlay duration (seconds)"
    )
    parser.add_argument("--font-size", type=int,
                        default=70, help="Title font size")
